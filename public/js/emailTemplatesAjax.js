...
/* Add new EmailTemplate table row */
...
$(".crud-submit").click(function(e) {
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('EmailTemplate Created Successfully.', 'Success Alert', {timeOut: 5000});
    });
});
...
$("body").on("click",".remove-item",function() {
    ...
    $.ajax({
        ...
        c_obj.remove();
        toastr.success('EmailTemplate Deleted Successfully.', 'Success Alert', {timeOut: 5000});
        getPageData();
    });
});
...
$(".crud-submit-edit").click(function(e) {
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        toastr.success('EmailTemplate Updated Successfully.', 'Success Alert', {timeOut: 5000});
    });
});
